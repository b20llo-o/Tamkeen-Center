...
(function () {
  ...
  const { Avatar, Btn, Badge, Card, EmptyState, Modal, Field, Input } = window.UI;
  ...
  function DashShell({ user, lang, setLang, panelLabel, accent, tabs, active, setActive, onLogout, onHome, children }) {
    const t = L(lang);
